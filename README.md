...
> I build intelligent automation pipelines using **n8n** to connect APIs, automate business processes, and eliminate repetitive tasks.

</div>

| Workflow | Description | Tools |
|---|---|---|
| 📧 **Smart Email Processor** | Auto-classify, prioritize and respond to emails using AI | n8n · OpenAI · Gmail |
| 📊 **Data Pipeline Automation** | Extract, transform and load data across multiple platforms | n8n · Webhooks · REST APIs |
